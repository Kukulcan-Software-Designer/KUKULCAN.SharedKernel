...
The **KUKULCAN.SharedKernel** project takes security seriously.
...
Responsible disclosure helps protect every application depending on **KUKULCAN.SharedKernel**.
...
The architecture of **KUKULCAN.SharedKernel** has been intentionally designed to reduce common sources of vulnerabilities.
...
Security is considered a fundamental architectural concern within **KUKULCAN.SharedKernel**.
...
Thank you for helping keep **KUKULCAN.SharedKernel** secure for the entire community.
