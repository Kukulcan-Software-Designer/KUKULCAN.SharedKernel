...
/// <summary>
/// Contains unit tests for <see cref="ConcurrencyException"/>.
/// </summary>
[TestFixture]
public sealed class ConcurrencyExceptionTests
{
    ...
    public void Constructor_WithError_ShouldCreateException()
    {
        ...
        var exception = new ConcurrencyException(error);
    ...
    /// </summary>
    [Test]
    public void ConcurrencyException_ShouldDeriveFromSharedKernelException()
    {
        var exception = new ConcurrencyException(CreateError());
    ...
    /// </summary>
    [Test]
    public void ConcurrencyException_ShouldDeriveFromException()
    {
        var exception = new ConcurrencyException(CreateError());
    ...
    /// </summary>
    [Test]
    public void ConcurrencyException_ShouldHaveExpectedRuntimeType()
    {
        var exception = new ConcurrencyException(CreateError());

        Assert.That(
            exception.GetType(),
            Is.EqualTo(typeof(ConcurrencyException)));
    }

    /// <summary>
    /// Creates a representative concurrency error for the tests.
    /// </summary>
