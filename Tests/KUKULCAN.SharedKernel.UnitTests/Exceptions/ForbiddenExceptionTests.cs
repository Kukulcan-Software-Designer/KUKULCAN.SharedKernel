...
/// <summary>
/// Contains unit tests for <see cref="ForbiddenException"/>.
/// </summary>
[TestFixture]
public sealed class ForbiddenExceptionTests
{
    ...
    /// </summary>
    [Test]
    public void ForbiddenException_ShouldDeriveFromSharedKernelException()
    {
        var exception = new ForbiddenException(CreateError());
    ...
    /// </summary>
    [Test]
    public void ForbiddenException_ShouldDeriveFromException()
    {
        var exception = new ForbiddenException(CreateError());
    ...
    /// </summary>
    [Test]
    public void ForbiddenException_ShouldHaveExpectedRuntimeType()
    {
        var exception = new ForbiddenException(CreateError());

        Assert.That(
            exception.GetType(),
            Is.EqualTo(typeof(ForbiddenException)));
    }

    /// <summary>
    /// Creates a representative forbidden error for the tests.
    /// </summary>
