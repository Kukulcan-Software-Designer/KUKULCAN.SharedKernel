...
/// <summary>
/// Contains unit tests for <see cref="DomainException"/>.
/// </summary>
[TestFixture]
public sealed class DomainExceptionTests
{
    ...
    /// </summary>
    [Test]
    public void DomainException_ShouldDeriveFromException()
    {
        var exception = new DomainException(CreateError());
    ...
    /// </summary>
    [Test]
    public void DomainException_ShouldHaveExpectedRuntimeType()
    {
        var exception = new DomainException(CreateError());

        Assert.That(
            exception.GetType(),
            Is.EqualTo(typeof(DomainException)));
    }
