...
/// <summary>
/// Contains unit tests for <see cref="UnauthorizedException"/>.
/// </summary>
[TestFixture]
public sealed class UnauthorizedExceptionTests
{
    ...
    /// </summary>
    [Test]
    public void UnauthorizedException_ShouldDeriveFromSharedKernelException()
    {
        var exception = new UnauthorizedException(CreateError());
    ...
    /// </summary>
    [Test]
    public void UnauthorizedException_ShouldDeriveFromException()
    {
        var exception = new UnauthorizedException(CreateError());
    ...
    /// </summary>
    [Test]
    public void UnauthorizedException_ShouldHaveExpectedRuntimeType()
    {
        var exception = new UnauthorizedException(CreateError());

        Assert.That(
            exception.GetType(),
            Is.EqualTo(typeof(UnauthorizedException)));
    }

    /// <summary>
    /// Creates a representative unauthorized error for the tests.
    /// </summary>
