...
The purpose of this document is to define the long-term governance model of **KUKULCAN.SharedKernel**.

Unlike many libraries that evolve organically over time, KUKULCAN.SharedKernel follows a deliberate architectural process designed to maximize:
...
KUKULCAN.SharedKernel aims to become a stable architectural foundation for enterprise software built on top of:
...
KUKULCAN.SharedKernel is not intended to become a collection of utilities.
